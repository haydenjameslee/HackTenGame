...
public class DynamicCircuit : MonoBehaviour 
{
    ...
    //private int currentNodeGraphWidth;
    //private int currentNodeGraphHeight;
    ...
    private void MoveLines()
    {
        for(LinkedListNode<CircuitLineData> CurrentLineNode = lineList.First;CurrentLineNode != null;CurrentLineNode = CurrentLineNode.Next)
        {
            ...
            else
            {
                ...
                int NumberOfSegments = (lineLength * 2) * lineNodeDensity;
    ...
    private void SpawnALine()
    {
        ...
        NewLine.Line.castShadows = false;
        ...
        if (lineEnd == null)
        {
            ...
            ComponentRenderer.castShadows = false;
